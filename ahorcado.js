...
function generarABC (a,z){
    ...
    for (; i<=j; i++){
        ...
        if(i==110){
            document.getElementById("abcdario").innerHTML += "<button value='Ñ' onclick='intento(\"Ñ\")' class='letra' id='Ñ'>Ñ</button>"; //id='Ñ' soluciona el error
        }
    }
}
